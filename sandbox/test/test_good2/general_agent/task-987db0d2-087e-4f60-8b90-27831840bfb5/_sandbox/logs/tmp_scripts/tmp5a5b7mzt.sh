...
URL=https://raw.githubusercontent.com/mohansaidinesh/Travel-Recommendation-System/main/Travel%20details%20dataset.csv TARGET=data/raw/mohansaidinesh-travel-recommendation-system-main.csv MAX_BYTES=20000000 TIMEOUT=15 python - <<'PY'
