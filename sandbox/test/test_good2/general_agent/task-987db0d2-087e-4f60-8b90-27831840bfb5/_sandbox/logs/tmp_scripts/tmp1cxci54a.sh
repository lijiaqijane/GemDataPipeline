...
URL=https://raw.githubusercontent.com/CopilotKit/CopilotKit/main/examples/coagents-travel/agent/langgraph.json TARGET=data/raw/copilotkit-copilotkit-main-examples-coagents-tra.json MAX_BYTES=20000000 TIMEOUT=15 python - <<'PY'
