...
URL=https://raw.githubusercontent.com/bixbydevelopers/sample-template-import-data/master/hotels/hotels.csv TARGET=data/raw/bixbydevelopers-sample-template-import-data-mast.csv MAX_BYTES=20000000 TIMEOUT=15 python - <<'PY'
